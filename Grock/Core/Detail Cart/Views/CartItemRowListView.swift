...
//            .opacity(cartItem.isFulfilled ? 0.5 : 1.0)
//        }
//        .opacity(cartItem.isSkippedDuringShopping ? 0.5 : 1.0)
//        .strikethrough(cartItem.isSkippedDuringShopping, color: Color(hex: "999"))
        ...
        HStack(alignment: .top, spacing: cart.isShopping ? 8 : 0) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                Text("\(quantityString) \(itemName)")
                    ...
                    .lineLimit(3)
                    .fixedSize(horizontal: false, vertical: true)
                    // FIXED: Remove strikethrough when in planning mode
                ...
                .foregroundColor(Color(hex: "231F30"))
                // FIXED: Only gray out in shopping mode if fulfilled/skipped
