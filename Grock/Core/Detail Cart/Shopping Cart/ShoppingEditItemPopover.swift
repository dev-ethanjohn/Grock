...
private struct PriceField: View {
    ...
    @FocusState.Binding var focusedField: ShoppingEditItemPopover.Field?
    let plannedUnit: String
...
// MARK: - Input Fields Container
private struct InputFieldsContainer: View {
    @Binding var price: String
    @Binding var portion: String
    @FocusState.Binding var focusedField: ShoppingEditItemPopover.Field?
    let plannedUnit: String
...
// MARK: - Form Valid Indicator
private struct FormValidIndicator: View {
    var body: some View {
    ...
    var body: some View {
        VStack(spacing: 6) {
            ...
            FormCompletionButton(
                title: hasChanges ? "Update purchase" : "Confirm",
...
// MARK: - Main ShoppingEditItemPopover
struct ShoppingEditItemPopover: View {
    @Binding var isPresented: Bool
    let item: Item
    let cart: Cart
        ...
        ZStack {
            ...
            VStack(spacing: 18) {
                ...
                .onAppear {
                    ...
                    portion = String(currentQuantity)
                }
                
                // Form valid indicator
//                if isFormValid {
//                    FormValidIndicator()
//                        .animation(.spring(response: 0.4, dampingFraction: 0.7), value: isFormValid)
//                }
